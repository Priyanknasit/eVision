...
//                {
//                    Intent intent=new Intent(Activity4.this,com.example.bh1.Activity1.class);
//                    startActivity(intent);
//                }
//                if(command.contains("two") || command.contains("2"))
//                {
//                    Intent intent=new Intent(Activity4.this,com.example.bh1.Activity2.class);
//                    startActivity(intent);
//                }
//                if(command.contains("three") || command.contains("3"))
//                {
//                    Intent intent=new Intent(Activity4.this,com.example.bh1.Activity3.class);
//                    startActivity(intent);
//                }
//                if(command.contains("four") || command.contains("4"))
//                {
//                    Intent intent=new Intent(Activity4.this,com.example.bh1.Activity4.class);
//                    startActivity(intent);
//                }
//                if(command.contains("menu"))
//                {
//                    Intent intent=new Intent(Activity4.this,com.example.bh1.MainActivity.class);
//                    startActivity(intent);
//                }
//            }
//
