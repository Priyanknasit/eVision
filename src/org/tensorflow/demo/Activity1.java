...
//                {
//                    Intent intent=new Intent(Activity1.this,org.tensorflow.demo.Activity1.class);
//                    startActivity(intent);
//                }
//                if(command.contains("two") || command.contains("2"))
//                {
//                    Intent intent=new Intent(Activity1.this,org.tensorflow.demo.Activity2.class);
//                    startActivity(intent);
//                }
//                if(command.contains("three") || command.contains("3"))
//                {
//                    Intent intent=new Intent(Activity1.this,org.tensorflow.demo.Activity3.class);
//                    startActivity(intent);
//                }
//                if(command.contains("four") || command.contains("4"))
//                {
//                    Intent intent=new Intent(Activity1.this,org.tensorflow.demo.Activity4.class);
//                    startActivity(intent);
//                }
//                if(command.contains("menu"))
//                {
//                    Intent intent=new Intent(Activity1.this,org.tensorflow.demo.MainActivity.class);
//                    startActivity(intent);
//                }
//            }
//        }
